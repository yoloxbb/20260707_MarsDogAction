...
class BehaviorGoal:
    ...
    Attributes:
        ...
        behavior_name: Logical behavior to execute (e.g. ``"wagTailFast"``).
...
class ActionStage:
    ...
    Attributes:
        ...
        selection_policy: How to pick — ``"random"``, ``"first"``, ``"weighted"``.
...
class ActionPlan:
    ...
    goal_id: str
    behavior_name: str
    resolved_behavior_name: str = ""  # canonical name after alias resolution
...
class ExecutionFeedback:
    ...
    Published at ~10 Hz via Action feedback and optional debug topic.
